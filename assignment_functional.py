...
exp_prods = ['Cucumber - 1 Kg', 'Raspberry - 1/4 Kg', 'Strawberry - 1/4 Kg']
act_prods = []

#---------------- Compare and assert expected list with actual list in single line ------------------------------
# act_prods = driver.find_elements(By.XPATH,"//div[@class='products']/div/h4")
# act_prod_names = [prod.text for prod in act_prods]
# print("Actual Products List from web:",act_prod_names)
# assert act_prod_names == exp_prods
